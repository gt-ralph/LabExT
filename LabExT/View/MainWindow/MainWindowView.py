...
class MainWindowContextMenu(Menu):
    ...
    def __init__(self, parent, menu_listener):
        ...
        self._file.add_command(label="Load Experiment Queue...", command=self._menu_listener.client_load_queue)
        self._file.add_command(label="Save Experiment Queue...", command=self._menu_listener.client_save_queue)
